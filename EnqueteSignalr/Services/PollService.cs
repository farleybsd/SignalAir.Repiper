...
namespace EnqueteSignalr.Services
{
    public class PollService
    {
        ...
        public List<Poll> GetPolls() => _polls; 
        public Poll GetPoll(int PollId) => _polls.FirstOrDefault(p => p.Id == PollId) ;
